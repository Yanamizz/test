...
class CGigeRecovery {
 ...
 private:
  ...
  static void GX_STDC __OnDeviceOfflineCallbackFun(void *user_param);
...
*/
//----------------------------------------------------------------------------------
void GX_STDC CGigeRecovery::__OnDeviceOfflineCallbackFun(void *user_param) {
...
bool CGigeRecovery::__OnCloseDevice() {
  ...
  if (m_frame_data.pImgBuf != NULL) {
    delete[] static_cast<BYTE *>(m_frame_data.pImgBuf);
