...
struct RuntimeParams {
  ...
  std::string angle_filter_type;   ///< 角度滤波器类型，见 AngleCalculator::ParseFilterType
  ...
  bool enable_motion_prediction; ///< 是否启用跨帧运动预测
...
inline const RuntimeParams &Params() {
  static const RuntimeParams p{
      ...
      1000.0, // stage3_exposure_time_us
