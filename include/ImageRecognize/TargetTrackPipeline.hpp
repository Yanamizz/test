...
class TargetTrackPipeline {
 ...
 private:
  static TemporalBoxStabilizer MakeStage12Stabilizer_() {
    ...
    params.min_iou_to_stabilize = 0.34f;
    params.max_center_distance_ratio = 0.62f;
    params.max_area_ratio = 1.38f;
    params.max_height_expand_ratio = 1.02f;
    params.center_min_cutoff_hz = 0.90;
    params.center_beta = 0.12;
    params.size_min_cutoff_hz = 0.40;
    params.size_beta = 0.02;
    params.center_x_min_cutoff_hz = 1.85;
    params.center_y_min_cutoff_hz = 0.82;
    params.center_x_beta = 0.24;
    params.center_y_beta = 0.10;
    params.width_min_cutoff_hz = 0.55;
    params.height_min_cutoff_hz = 0.25;
    params.width_beta = 0.02;
    params.height_beta = 0.008;
  ...
  static TemporalBoxStabilizer MakeStage3Stabilizer_() {
    ...
    params.max_center_distance_ratio = 0.56f;
    params.max_area_ratio = 1.28f;
    params.max_height_expand_ratio = 1.015f;
    params.center_min_cutoff_hz = 0.62;
    params.center_beta = 0.035;
    params.size_min_cutoff_hz = 0.28;
    params.size_beta = 0.006;
    params.center_x_min_cutoff_hz = 0.72;
    params.center_y_min_cutoff_hz = 0.45;
    params.center_x_beta = 0.05;
    params.center_y_beta = 0.025;
    params.width_min_cutoff_hz = 0.30;
    params.height_min_cutoff_hz = 0.18;
    params.width_beta = 0.007;
    params.height_beta = 0.0025;
    return TemporalBoxStabilizer(params);
  }
